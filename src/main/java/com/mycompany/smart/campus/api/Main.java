...
/**
 * Main class to bootstrap the Smart Campus API.
 */
public class Main {
    ...
    public static HttpServer startServer() {
        ...
        // in com.mycompany.smart.campus.api package
        final ResourceConfig rc = new SmartCampusApp();
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Test it at: " + BASE_URI);
